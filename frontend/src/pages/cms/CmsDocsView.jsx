  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const docFormateado = {
        ...
        fileType: (archivo?.name || nombreArchivoActual || "")
            ...
            docsList.map((doc) => (
              <div className="activity-row docs-table-row" key={doc.id}>
                ...
                <div className="doc-actions-cell">
                  <button title="Editar" onClick={() => handleOpenEdit(doc)}
                  ...
                  <button title="Eliminar" onClick={() => onDeleteDoc(doc.id)}
