...
const CmsSidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className={`cms-sidebar ${isCollapsed ? "collapsed" : ""}`}>
      {/* Cabecera Principal con tu Logo */}
      <div className="cms-sidebar-header">
        <div className="cms-logo-container-inner">
          <div className="cms-logo">
            <img src={avatarHospital} alt="Logo Hospital Evita" className="cms-logo-img" />
            {!isCollapsed && (
      ...
      {!isCollapsed && <div className="cms-sidebar-menu-title">PANEL DE ADMINISTRACIÓN</div>}

      {/* Navegación por Secciones */}
      <nav className="cms-nav">
        {menuSections.map((section, idx) => (
          <div className="cms-nav-group" key={idx}>
            {!isCollapsed && <div className="cms-nav-group-title">{section.title}</div>}
            <ul>
              {section.items.map((item) => (
                ...
                >
                  ...
                  {!isCollapsed && <span className="cms-nav-label">{item.label}</span>}
                </li>
              ))}
            </ul>
          </div>
